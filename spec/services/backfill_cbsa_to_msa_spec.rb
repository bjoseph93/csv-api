...
RSpec.describe BackfillCbsaToMsa do
	context "the row has a mdiv that matches a cbsa" do
		it "replaces the existing cbsa with the new cbsa" do
			...
			msa_array = [
				[4000, 6000, 48059, "Abilene, TX", "Metropolitan Statistical Area", 165252, 165252, 165609,	166639,	167578,	167549, 168380, 169578]
			]
			BackfillCbsaToMsa.execute(msa_array)
	...
	context "there is a mdiv that does not match a cbsa" do
		context "the cbsa matches an existing cbsa" do
			it "updates the attributes of matching row" do
				text_zip = ZipCode.create!(zip: 500, cbsa: 6000)
				msa_array = [
					[6000, 5000, 48059, "Abilene, TX", "Metropolitan Statistical Area", 165252, 165252, 165609,	166639,	167578,	167549, 168380, 169578]
		...
		context "the cbsa does not match an existing cbsa" do
			it "does not update a ZipCode" do
				text_zip = ZipCode.create!(zip: 500, cbsa: 6000)
				msa_array = [
					[4000, 5000, 48059, "Abilene, TX", "Metropolitan Statistical Area", 165252, 165252, 165609,	166639,	167578,	167549, 168380, 169578]
	...
	context "there is no mdiv" do 
		it "updates matching attributes of matching cbsa" do
			...
			msa_array = [
				[4000, nil, 48059, "Abilene, TX", "Metropolitan Statistical Area", 165252, 165252, 165609,	166639,	167578,	167549, 168380, 169578]
			]
	...
	context "the lsad is not Metropolitan Statistical Area" do 
		it "does not update the zip code" do
			text_zip = ZipCode.create!(zip: 500, cbsa: 6000)
				msa_array = [
					[6000, 5000, 48059, "Abilene, TX", "County or equivalent", 165252, 165252, 165609,	166639,	167578,	167549, 168380, 169578]
